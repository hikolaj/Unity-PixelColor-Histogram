...
public class RGBMonitor : MonoBehaviour
{
    ...
    // Make screen shot and save it to pixel counter
    ...
    // Count color values per pixel using compute shader
    ...
    // Update output histogram texture
    ...
    //////functions for histogram of reference image
